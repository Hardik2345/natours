 ...
 */
          ...
          (async (config) => {
            ...
            let [composedSignal, stopTimeout] =
              signal || cancelToken || timeout
                ? (0, _composeSignals.default)([signal, cancelToken], timeout)
                : [];
    ...
    'index.js': [
      function (require, module, exports) {
        ...
        //Delegation
        if (mapElement) {
          var locations = JSON.parse(mapElement.dataset.location);
